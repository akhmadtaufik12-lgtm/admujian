...
export const RoomsView: React.FC<RoomsViewProps> = ({
  ...
  const handleAddSubmit = (e: React.FormEvent) => {
    ...
    onAddRoom({
      ...
      proctor1: newRoom.proctor1 || 'Guru Pengawas 1',
      proctor2: newRoom.proctor2 || 'Guru Pengawas 2',
    });
              ...
              <div className="space-y-3">
                ...
                <div className="pt-2 border-t border-slate-100 space-y-1 text-xs text-slate-600">
                  <div className="flex items-center gap-1.5 text-[11px]">
                    ...
                    <span>Pengawas 1: <strong className="text-slate-800">{room.proctor1 || '-'}</strong></span>
                  </div>
                  <div className="flex items-center gap-1.5 text-[11px]">
                    <UserCheck className="w-3.5 h-3.5 text-slate-400" />
                    <span>Pengawas 2: <strong className="text-slate-800">{room.proctor2 || '-'}</strong></span>
                  </div>
                </div>
              </div>
            ...
            <form onSubmit={handleAddSubmit} className="space-y-3 pt-3">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Nama Lengkap & Gelar Pengawas 1"
                  className="w-full px-3 py-1.5 text-xs border border-slate-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  value={newRoom.proctor2}
                  onChange={(e) => setNewRoom({ ...newRoom, proctor2: e.target.value })}
                  placeholder="Nama Lengkap & Gelar Pengawas 2"
                  className="w-full px-3 py-1.5 text-xs border border-slate-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                />
              </div>
            ...
            <form onSubmit={handleEditSubmit} className="space-y-3 pt-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditingRoom({ ...editingRoom, proctor1: e.target.value })}
                  className="w-full px-3 py-1.5 text-xs border border-slate-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  value={editingRoom.proctor2}
                  onChange={(e) => setEditingRoom({ ...editingRoom, proctor2: e.target.value })}
                  className="w-full px-3 py-1.5 text-xs border border-slate-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                />
              </div>
